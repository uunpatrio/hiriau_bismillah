...
class M_visualisasi extends CI_Model
{
    ...
    public function getDonaturPertahun()
    {
        $this->db->select('fd.id_fact_donatur, count(dd.id_donatur) as tot_donatur, dw.bulan, dw.tahun');
    ...
    public function donaturByTahun($tahun)
    {
        $this->db->select('fd.id_fact_donatur, count(fd.id_donatur) as tot_donatur, dw.bulan, dw.tahun');
        $this->db->from('fact_donatur fd');
        $this->db->join('dim_donatur dd', 'dd.id_donatur = fd.id_donatur', 'left');
        $this->db->join('dim_waktu dw', 'dw.id_waktu = fd.id_waktu', 'left');
